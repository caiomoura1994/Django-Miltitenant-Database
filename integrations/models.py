...
class RdStationZapei(models.Model):
    url_sufix = models.CharField(
        ...
        help_text="Acesse https://app.rdstation.com.br/integracoes/webhooks > clique em Criar Webhook > Escolha um nome, no campo GATILHO selecione: Conversão, no campo URL coloque: https://zapei-api.herokuapp.com/integrations/rd-zapei/'Sufixo do cliente'/, Eventos de Conversão pode ficar Vazio"
    )
